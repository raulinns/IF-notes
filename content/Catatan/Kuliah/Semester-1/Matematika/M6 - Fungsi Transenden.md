...
- Quick Access
    ...
    - [[#📝 Notes]]
    - [[#Fungsi Transenden]]
        - [[#Fungsi Logaritma Alami (@import url('https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.16.9/katex.min.css')ln⁡x\ln xlnx﻿)]]
        ...
        - [[#Turunan Fungsi @import url('https://cdnjs.cloudflare.com/ajax/libs/KaTeX/0.16.9/katex.min.css')exe^xex﻿]]
...
$$\boxed{\ln x = \int_1^x \frac{1}{t}\ \mathrm{d}t}$$

![[diagram-20231205_(7).svg]]
...
1. $\ln 1 = 0$
    - Bukti
        ...
        $\displaystyle \int_1^1 \frac{1}{t} \ \mathrm{d}t$ berarti luas area di bawah kurva $\displaystyle\frac1t$ dari $x = 1$ sampai $x =1$ sehingga luas areanya adalah 0.
...
4. $\ln x^r = r \ln x$
    - Bukti
        ...
        $$C = 0 \implies \boxed{\ln x^r = r \ln x}$$
...
![[diagram-20231205_(4).svg]]

Gambar 3

> [!important] Fungsi $f : X \to Y$ disebut satu-satu di $X$, dalam hal untuk setiap $x \in X$ berlaku jika $f(x_1) = f(x_2)$, maka $x_1 = y_2$ atau bisa juga ditulis jika $x_1 \ne x_2$, maka $f(x_1) \ne f(x_2)$

Sehingga, dari definisi tersebut dapat diperoleh

> [!important] Jika $f$ monoton di interval $I$, maka $f$ termasuk fungsi satu-satu di interval $I$.
...
> [!important] Jika $f$ monoton di interval $I$, maka $f$ memiliki invers di interval $I$.
