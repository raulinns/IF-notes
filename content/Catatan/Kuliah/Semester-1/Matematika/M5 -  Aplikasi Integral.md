...
- Volume Benda
    ...
    1. Aproksimasi nilai volumenya
        
        $$V \approx \sum_{i=1}^n \Delta V_i = \sum_{i=1}^n L(\bar x_i) \ \Delta x$$
        
    2. Volume sesungguhnya adalah limit jumlah Riemann aproksimasi nilai volumenya
...
- Volume Benda Putar
    ...
    ### Metode Cakram (_disks)_
    
    ![[image 3 10.png|image 3 10.png]]
    
    Gambar 4.5
    
    Dalam metode ini, luas dari penampangnya adalah luas lingkaran.
    
    Maka, $\text{Luas} = \pi r^2 \implies L(x)=\pi f(x)^2 \implies \Delta V \approx \pi f(x)^2 \ \Delta x \implies V = \pi \int_a^b f(x)^2 \ dx$
    
      
    
    ### Metode Cincin (_washers)_
    
    ![[image 4 10.png|image 4 10.png]]
    
    Gambar 4.6
    
    Dalam metode ini, luas dari penampangnya adalah luas lingkaran luar dikurang luas lingkaran dalam.
    
    Maka, $\text{Luas} = \pi R^2- \pi r^2 = \pi (R^2-r^2) \implies \pi [f(x)^2-g(x)^2] \implies \Delta V \approx \pi [f(x)^2-g(x)^2] \ \Delta x \implies V = \pi[f(x)^2-g(x)^2] \ \rm{d} x$
    ...
    Sehingga, dalam metode ini, luas penampang dari kulit tabung ini adalah persegi panjang.
    
    Maka, $\text{Luas} = p \cdot l =2\pi \cdot r \cdot h \implies L(x) = 2\pi \cdot x \cdot f(x) \implies \Delta V \approx 2\pi \cdot x \cdot f(x) \cdot \Delta x \implies V = 2\pi \int_a^bx \cdot f(x) \ dx$
...
- Volume Benda Nonputar
    ...
    Dalam metode ini, penampangnya adalah fungsi yang diketahui. Namun, kita menghitung volumenya dengan luas dari _cross section-_nya dan tebal dengan $\Delta x$.
    ...
    - Jika _cross section_-nya adalah segitiga sama sisi, karena masing-masing sudutnya adalah $60^o$, maka jika masing-masing sisinya adalah $u$, maka ketinggiannya adalah $\sin 60^o = \frac{\sqrt{3}}{2}u$.
        ...
        Sehingga, $\text{Luas} = \frac12 \cdot a \cdot t = \frac12 u \cdot \frac{\sqrt{3}}{2}u = \frac{\sqrt{3}}{4}u^2$ (Lihat **Gambar 4.8**) $\implies L(x) = \frac{\sqrt{3}}{4}f(x)^2 \implies \Delta V \approx \frac{\sqrt{3}}{4}f(x)^2 \ \Delta x \implies V = \frac{\sqrt{3}}{4}\int_a^bf(x)^2 \ dx$
...
- Usaha
    ...
    3. Aproksimasi nilai kerjanya
        
        $$W \approx \sum_{i=1}^n F(\bar x_i)\ \Delta x$$
        
    4. Luas sesungguhnya adalah limit jumlah Riemann aproksimasi luas daerahnya
